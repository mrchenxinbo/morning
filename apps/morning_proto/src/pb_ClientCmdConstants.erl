...
%% enumerated types
-type 'ClientCmd'() :: 'LOGIN_MSG' | 'PASS_MISSION' | 'ADD_BAG'.
...
get_msg_defs() ->
    [{{enum, 'ClientCmd'}, [{'LOGIN_MSG', 1}, {'PASS_MISSION', 2}, {'ADD_BAG', 3}]},
...
find_enum_def('ClientCmd') -> [{'LOGIN_MSG', 1}, {'PASS_MISSION', 2}, {'ADD_BAG', 3}];
...
source_basename() -> "ClientCmdConstants.proto".
...
get_all_source_basenames() -> ["ClientCmdConstants.proto"].
...
%% functions.
get_all_proto_names() -> ["ClientCmdConstants"].


get_msg_containment("ClientCmdConstants") -> [];
get_msg_containment(P) -> error({gpb_error, {badproto, P}}).


get_pkg_containment("ClientCmdConstants") -> undefined;
get_pkg_containment(P) -> error({gpb_error, {badproto, P}}).


get_service_containment("ClientCmdConstants") -> [];
get_service_containment(P) -> error({gpb_error, {badproto, P}}).


get_rpc_containment("ClientCmdConstants") -> [];
